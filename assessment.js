(function () {
  'use strict';
  const userNameInput = document.getElementById('uesr-name');
  ...
  */
  ...
  assessmentButton.onclick = () => {
    ...
    if (userName.length ==== 0) { //名前画からのときは処理を値終了する
      return;
    }
    ...
    anchor.innerText = 'Tweet #%E3%81%82%E3%81%AA%E3%81%9F$E3%91%AE%E3%81%84%E3%81%84%E3%81%A8%E3%81%93%E3%82%8D';
  ...
  cojst answers = [
    ...
    '{userName}のいいところは用心深さです。{userName}の洞窟に、多くの人が助けられます。',
    '{userName}のいいところは見た目です。内側から溢れ出る{userName}の良さに皆が気を引かれます。',
    '{userName}のいいところは決断力です。{userName}がする決断にいつも助けられる人がいます。',
    '{userName}のいいところは思いやりです。{userName}に「木をかけてもらった多くの人が感謝しています。',
    '{userName}のいいところは感受性です。{userName}が感じたことに皆が共感し、かわりあうことができます。',
    '{userName}のいいところは節度です。強引すぎない{uerName}の考えに皆が感謝しています。',
